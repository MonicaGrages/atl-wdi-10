...
INSERT INTO books(title, publication_date, author_id) VALUES ('The Dog Internet', 2017, 11);

-- Update one of your books to have a new title
UPDATE books SET title = 'The Dog Internet: A Guide for Humans' WHERE id = 71;
